    ...
    <div class="contact__grid">
      <form class="panel form" id="lead-form">
        <div class="form__fields">
          ...
          <label class="field">
            <span class="field__label">Как с&nbsp;вами связаться <span class="field__req" aria-hidden="true">*</span></span>
            <input type="text" name="contact" placeholder="Почта, телефон или мессенджер" autocomplete="email" inputmode="email" required aria-required="true">
          </label>
          <label class="field">
            <span class="field__label">Задача</span>
            <textarea name="task" placeholder="Например: нужен сайт музея к&nbsp;открытию выставки в&nbsp;марте"></textarea>
          </label>
        </div>
        ...
        <p class="form__promise">Ответим в&nbsp;течение рабочего дня: напишем на&nbsp;почту, уточним детали и&nbsp;предложим, как двигаться</p>
